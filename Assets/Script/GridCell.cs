...
//visualize every grid cell(the smallest unit of the grid, where each cell can only contain one object)
public class GridCell : MonoBehaviour
{
    ...
    void OnDrawGizmos()
    {
        ...
        // X-parallel lines (run along X for every Y/Z boundary)
        if (drawX)
        {
